    ...
    <header className="fixed top-0 left-0 right-0 bg-black z-50 border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2 text-white font-mono text-xs sm:text-sm md:text-base lg:text-lg flex-shrink-0 min-w-0">
            ...
            <span className="whitespace-nowrap">Francis Kierzkiewicz</span>
          </div>
